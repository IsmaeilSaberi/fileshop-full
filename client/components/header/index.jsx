        ...
        <div className="flex flex-col md:flex-row justify-start md:justify-between items-center md:items-start gap-1 md:gap-4 w-full">
          <div className="flex flex-col relative h-36 md:h-52 w-48 items-center">
            <Link
              ...
              href={"/"}
              className="logo bg-white flex flex-col gap-2 p-4 z-30 rounded-lg shadow-[0px_1px_10px_rgba(0,0,0,0.25)] cursor-pointer transition-all duration-150 hover:shadow-[0px_1px_10px_rgba(0,0,0,0.5)]"
            >
            ...
            <div
              ...
              className={
                logoHover == 0
                  ? "hidden md:flex absolute bg-red-100 bottom-20 right-0 left-0 z-10 justify-around items-center text-[1.6rem] p-2 text-indigo-600 rounded-bl-lg rounded-br-lg transition-all duration-300"
                  : "hidden md:flex absolute bg-red-100 bottom-0 right-0 left-0 z-10 justify-around items-center text-[1.6rem] p-2 text-indigo-600 rounded-bl-lg rounded-br-lg transition-all duration-300"
              }
            >
              <Link
                target="_blank"
          ...
          <div className="flex flex-col gap-4 w-full h-40 justify-between py-1">
